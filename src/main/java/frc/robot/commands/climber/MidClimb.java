...
public class MidClimb extends SequentialCommandGroup {
    ...
    public MidClimb(Climber climber) {
        ...
        new WaitCommand(1.0),
        new MoveArmsTo(climber, "partial-pullup", partialpullupext, midreachrot, true, true).withTimeout(TO),
        ...
        new MoveArmsTo(climber, "extend to hang", travers_start_ext, travers_start_rot, true, true).withTimeout(TO));
    }
}
