...
public class TraverseClimb extends SequentialCommandGroup {
    ...
    public TraverseClimb(Climber climber) {
        ...
        this.addCommands(
            ...
            new MoveArmsTo(climber, "partial-pullup-15", partialpullupext, -15, true, true).withTimeout(TO),
            new WaitCommand(10),
            new MoveArmsTo(climber, "pullupMid1", pullupext, -15, true, true).withTimeout(TO),
            new MoveArmsTo(climber, "pullupMid2", pullupext, -15, true, true).withTimeout(TO),
            new WaitCommand(5),
